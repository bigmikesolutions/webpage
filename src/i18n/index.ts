...
const messages = {
  ...
  en: {
    ...
    resume: { name: 'Michał Wroński', title: 'Senior Frontend Engineer & Product Designer', linkedin: 'https://www.linkedin.com/in/michal-wronski-b389a988/', summary_heading: 'Summary', summary: 'Senior frontend engineer and product designer experienced in building scalable web applications, UX and performant interfaces. Specializes in Vue, TypeScript and Tailwind.', experience_heading: 'Experience', education_heading: 'Education', skills_heading: 'Skills', role1_title: 'Senior Frontend Engineer', role1_company: 'Freelance / Various', role1_dates: '2018 – Present', role1_description: 'Designing and implementing user interfaces, design systems, and migrations to modern frameworks.', role2_title: 'Frontend Engineer', role2_company: 'Past Company', role2_dates: '2016 – 2018', role2_description: 'Building scalable SPA applications and performance optimization.', education_1: 'M.Sc. in Computer Science, University X' },
  },
}
